\begin{tad}{\tadNombre{Sistema}}
	...
	\tadAxiomas
		...
		\tadAxioma{pokemonsCapturados(j, registrarJugador(s,j'))}{\IF j = j' THEN 0 ELSE pokemonsCapturados(j,s) FI}
		...
		{\IF j = j' $\land$ (10 $\leq$ distancia(p, posicionJugador(j,s)) $\lor$ ($\neg$conexion?(p, posicionJugador(j,s), mapa(s)))) THEN 
			1 +	pokemonsCapturados(j,s)
		ELSE pokemonsCapturados(j,s) FI}
		...
		\tadAxioma{movimientosCercaDePos(j, p, agregarPokemon(s,pk,p'))}{movimientosCercaDePos(j, p, s)}
