\begin{tad}{\tadNombre{Sistema}}
	...
	\tadOtrasOperaciones
		...
		\tadOperacion{alguienCapturaPokemon?}{conj(jugador)/js, jugador/j, posicion/p, sistema/s}{bool}{js $\subseteq$ jugadoresConectados(jugadores(s), s) \\ $\land$ j $\in$ jugadoresConectados(jugadores(s), s) \\ $\land$ p $\in$ posiciones(mapa(s))}
